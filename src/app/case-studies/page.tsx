    ...
    <div className="min-h-screen bg-neutral-50 text-neutral-900 font-sans selection:bg-amber-500/30 selection:text-amber-800">
      ...
      <main className="max-w-6xl mx-auto px-6 pt-20 pb-24 relative">
        ...
        <div className="mb-16">
          ...
          <span className="text-xs uppercase tracking-widest text-neutral-500 font-bold block">TECHNICAL DEPLOYMENTS</span>
        ...
        <div className="space-y-16">
          ...
          {/* Case Study 1 */}
          <div className="bg-neutral-200/40 border border-neutral-200 rounded-2xl p-8 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center hover:border-neutral-300/60 transition-all duration-300">
            <div className="lg:col-span-5 aspect-[16/10] w-full overflow-hidden bg-neutral-50 relative rounded-xl border border-neutral-200">
              <img 
            ...
            <div className="lg:col-span-7 flex flex-col justify-between h-full">
              <div>
                ...
                <h2 className="text-2xl font-bold text-neutral-900 tracking-tight mb-4">
                ...
                <div className="grid grid-cols-3 gap-4 border-t border-neutral-200 pt-4 mb-4">
                  <div>
                    <span className="text-xs text-neutral-500 block font-mono">TOLERANCE</span>
                    <span className="text-sm font-bold text-neutral-700">±0.02mm</span>
                  </div>
                  <div>
                    <span className="text-xs text-neutral-500 block font-mono">LOAD CAP</span>
                    <span className="text-sm font-bold text-neutral-700">120kg Max</span>
                  </div>
                  <div>
                    <span className="text-xs text-neutral-500 block font-mono">EFFICIENCY</span>
          ...
          <div className="bg-neutral-200/40 border border-neutral-200 rounded-2xl p-8 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center hover:border-neutral-300/60 transition-all duration-300">
            ...
            <div className="lg:col-span-7 flex flex-col justify-between h-full">
              <div>
                ...
                <div className="grid grid-cols-3 gap-4 border-t border-neutral-200 pt-4 mb-4">
                  <div>
                    <span className="text-xs text-neutral-500 block font-mono">MATERIAL</span>
                    <span className="text-sm font-bold text-neutral-700">Grade 316 SS</span>
                  </div>
                  <div>
                    <span className="text-xs text-neutral-500 block font-mono">RETENTION</span>
                    <span className="text-sm font-bold text-neutral-700">36 Hours Cold</span>
                  </div>
                  <div>
                    <span className="text-xs text-neutral-500 block font-mono">VACUUM DEPTH</span>
          ...
          <div className="bg-neutral-200/40 border border-neutral-200 rounded-2xl p-8 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center hover:border-neutral-300/60 transition-all duration-300">
            ...
            <div className="lg:col-span-7 flex flex-col justify-between h-full">
              <div>
                ...
                <div className="grid grid-cols-3 gap-4 border-t border-neutral-200 pt-4 mb-4">
                  <div>
                    <span className="text-xs text-neutral-500 block font-mono">RIGIDITY RATIO</span>
                    <span className="text-sm font-bold text-neutral-700">Zero Flex (Cast)</span>
                  </div>
                  <div>
                    <span className="text-xs text-neutral-500 block font-mono">LOAD RATING</span>
                    <span className="text-sm font-bold text-neutral-700">240kg Dynamic</span>
                  </div>
                  <div>
                    <span className="text-xs text-neutral-500 block font-mono">INTEGRATION</span>
